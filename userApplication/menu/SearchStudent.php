...
<div id="content" align="center">
  <div class="sub-title" align="left" style="padding-bottom:30px;">
    <h3 style="font-weight:bold;">Search Student</h4>
  </div>
      ...
      <table class="search-table table table-hover">
        ...
        <tbody>
          <?php
            ...
            $itemController->checkStudentPeriod();
            ...
            while ($row = $result->fetch_assoc()){
              $bold = false;
              $background = "";
              $bolds = $itemController->loadBold($row['id'], 'student');
              $bgs = $itemController->loadBackground($row['id'], 'student');
              ...
              echo "<tr onclick='location.href=\"".$pageName."?pageNum=".$pageNum."&position=student\";'>";
                ...
                echo "<td style='".$bold_tag.$background_tag."' scope='row'>".$row['school']."</td>";
