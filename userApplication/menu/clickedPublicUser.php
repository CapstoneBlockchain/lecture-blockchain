...
<div id="content" align="center">
  <div id="request_table" align="center">
    ...
    <div class="">
      <?php
        echo '<input type="button" class="btn-dark" value="Request" onclick="location.href=\'registerWaitUser.php?to_id='.$row['id'].'&type=matching\'">';
        if ($_SESSION['userPossition'] == 'student'){
          echo '<input type="button" class="btn-dark" value="Counseling" onclick="location.href=\'registerWaitUser.php?to_id='.$row['id'].'&type=counseling\'">';
        }
       ?>
